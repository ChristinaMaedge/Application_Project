...
Der VIF-Wert für die Variablen `Datum` und `Jahr` sind sehr hoch (VIF = 50.184566 respektive 48.757019). Dies könnte problematisch sein. Die Variablen werden insofern ebenfalls entfernt.


**Umgang mit Multikollinearität**
In diesem Abschnitt, wird das Modell erneut erstellt. Dieses Mal ohne die beiden problematischen Variablen.
...
```{r}
best_subset <- regsubsets(Umsatz ~ ., df_lm_train_WG1, nvmax = 15)
```
