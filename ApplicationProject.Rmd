...
Wir haben jetzt die Gütekennzahlen für die Warengruppen 1, 2 und 5 ermittelt und zwar für verschiedene Modelle. Innerhalb der Warengruppen unterscheiden sich die Modelle nur marginal. Das spricht dafür, jeweils das einfachste Modell zu verwenden, also mit möglichst wenig Variablen. Für die Warengruppe 1 entscheiden wir uns für das Modell mit 31 Variablen, für die Warengruppe 2 mit 19 Variablen und für die Warengruppe 5 mit nur 10 Variablen.
...
Nochmal zusammenfassen, für welche Warengruppen sich die Umsätze besonders gut schätzen lassen (WG2 und 5) und welche Güte-Kennzahlen wir für die verschiedenen besten Modelle aus allen Bereichen finden.

And the winner is...

Und Gesamtfazit: Wir hatten uns erhoft, eine bessere Prognosegüte zu erzielen. Aber vielleicht lassen sich die Umsätze mit unserem Datenmodell gar nicht besser schätzen. Möglicherweise bringt erst die Berücksichtigung weiterer Einflussfaktoren genauere Schätzergebnisse oder die Kombination unserer Modelle. Beides wird hier aber nicht weiter vertieft.

```{r}
Modellvergleich_total <- rbind(prog_MLP_vgl_kennz_mod2, lm_vgl_kennz)

Modellvergleich_total
```
