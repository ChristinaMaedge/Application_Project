...
* Insgesamt ist eine ähnliches Muster wie bei der Auswertung über alle Warengruppen erkennbar. Wieder scheinen die folgenden Variablen einen Einfluss zu haben:
  ...
  + Silvester
  + Sommer
* Hinzu kommen Temparatur, noch deutlicher der Wochentag und die erweiterte Osternvariable.
...
library(ggplot2)
library(dplyr)
lm_train_WG1 <- lm(Umsatz ~ Temperatur + Wochenende + SommerferienSH + SommerferienNRW + SommerferienNDS + SommerferienHE + Silvester + Sommer, data = df_train)
#tidy(lm_train_WG1)
#glance(lm_train_WG1)
summary.lm(lm_train_WG1)
```
