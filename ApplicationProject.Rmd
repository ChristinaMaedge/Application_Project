...
- mittlere Abweichung und Standardabweichung, Verteilung der Abweichungen
...
## 5.3 Prognose der Umsätze aufhand des Vorwochenwertes
...
# ergänze Abweichung (Schätzer - Umsatz), Prognose_zuhoch (TRUE / FALSE), quadratische Abweichung (Abweichung_quad)
...
# Prognosegüte: Anteil "zu hoch prognostiziert"
prog_naiv_lag_1W %>%
...
# Prognosegüte: mittlere Abweichung, Standardabweichung, Summe der Fehlerquadrate
prog_naiv_lag_1W %>%
  group_by(Warengruppe) %>%
  summarise(Anzahl = n(), mittlAbw=mean(Abweichung), StdAbw=sd(Abweichung), mittlAbw_quad=sum(Abweichung_quad)/n())
