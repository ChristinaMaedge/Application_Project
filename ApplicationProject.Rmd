...
svm regression with radial basis kernel, input mit Temperaturvariablen skaliert, Umsatz braucht nicht skaliert zu werden.
...
Wir eleminieren nun fehlende Werte, dummyfizieren Wochentag_c und Monat_c (wobei wir im Gegensatz zur linearen Regression alle Wochentage und alle Monate behalten) und skalieren die Variablen Umsatz, Temperatur, Bewoelkung und Windgeschwindigkeit auf Werte im Bereich zwischen 0 und 1. Danach werden die alten Variablen Wochentag_c und Monat_c entfernt.
...
# skaliere die Variablen Umsatz, Temperatur, Bewoelkung und Windgeschwindigkeit auf [0,1].
...
```{r}
write_csv(df_SVM_train_WG1, path="data/df_SVM_train_WG1.csv", col_names=FALSE)
write_csv(df_SVM_train_WG2, path="data/df_SVM_train_WG2.csv", col_names=FALSE)
write_csv(df_SVM_train_WG3, path="data/df_SVM_train_WG3.csv", col_names=FALSE)
write_csv(df_SVM_train_WG4, path="data/df_SVM_train_WG4.csv", col_names=FALSE)
write_csv(df_SVM_train_WG5, path="data/df_SVM_train_WG5.csv", col_names=FALSE)

write_csv(df_SVM_test_WG1, path="data/df_SVM_test_WG1.csv", col_names=FALSE)
write_csv(df_SVM_test_WG2, path="data/df_SVM_test_WG2.csv", col_names=FALSE)
write_csv(df_SVM_test_WG3, path="data/df_SVM_test_WG3.csv", col_names=FALSE)
write_csv(df_SVM_test_WG4, path="data/df_SVM_test_WG4.csv", col_names=FALSE)
write_csv(df_SVM_test_WG5, path="data/df_SVM_test_WG5.csv", col_names=FALSE)
```
