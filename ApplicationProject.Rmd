...
- Und bei den Multilayer Perceptronen hatten wir mit Modell 2 (mod2) gute Ergebnisse erzielt.
...
Für Warengruppe 2 liefern alle Modelle relativ gute Ergebnisse. Das naive Modell hat knapp die Nase vorn.
...
- Bilde für jede Warengruppe ein Ensemble der besten Modelle aus den unterschiedlichen Verfahren. 
- Gewichte die Umsatzschätzer jeweils zu gleichen Teilen.
- Wie sehen die Güte-Kennzahlen aus?

# 11 Zusammenfassung und Ausblick

Im Vergleich der Einzelmodelle finden wir ein Kopf-an-Kopf-Rennen zwischen dem besten naiven Modell und den linearen Modellen.

Die Support Vector Machines und Multilayer Perceptrons enttäuschen. Das zeigt zum einen, dass es sehr viel Erfahrung braucht, um diese komplexen Modelle zu optimieren. Diese Erfahrung fehlt uns.
...
Ergebnisse des Ensembles fehlen noch!
