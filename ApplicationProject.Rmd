...
```
Hier sehen wir, dass unsere Ergebnisse leicht unterschiedliche Modelle identifizieren, die als die besten angesehen werden. Die angepasste R2-Statistik legt nahe, dass das 10-Variablen-Modell bevorzugt wird, die BIC-Statistik schlägt das 4-Variablen-Modell vor und die Cp schlägt das 8-Variablen-Modell vor.
